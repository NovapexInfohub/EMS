...
export default function DashboardPage() {
    ...
    >
      ...
      >
        ...
        <CardContent>
          ...
          {/* Progress Bar for "Present Today" */}
          {stat.progress && (
            <>
  ...
  {[
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1605902711622-cfb43c4437d9?auto=format&fit=crop&w=800&q=80",
    },
  ].map((card, i) => (
    <motion.div
      key={i}
    ...
    >
      <Link href={card.href}>
        <div className="relative h-56 rounded-xl overflow-hidden shadow-lg group cursor-pointer">
          ...
          {/* Overlay */}
          <div
            className={`absolute inset-0 bg-gradient-to-r ${card.color} opacity-80`}
          ></div>
          ...
          <div className="relative z-10 p-6 flex flex-col justify-between h-full">
            ...
            <Button
              className="mt-4 w-full bg-white/20 hover:bg-white/30 text-white font-semibold backdrop-blur-sm"
            >
